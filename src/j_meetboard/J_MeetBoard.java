...
public class J_MeetBoard {
	...
	private int endRow; // 조회
	private String searchType;
	private String searchTxt; // 검색
	...
	public String toString() {
		return "J_MeetBoard [brd_no=" + brd_no + ", brd_subject=" + brd_subject
				+ ", brd_content=" + brd_content + ", brd_readcount="
				+ brd_readcount + ", brd_recommend=" + brd_recommend
				+ ", brd_ip=" + brd_ip + ", brd_reg_date=" + brd_reg_date
				+ ", brd_update_date=" + brd_update_date + ", brd_dey_yn="
				+ brd_del_yn + ", m_no=" + m_no + ", m_nick=" + m_nick
				+ ", l_code=" + l_code + ", c_value_lang=" + c_value_lang
				+ ", mc_code=" + mc_code + ", c_value_cate=" + c_value_cate
				+ "]";
	}
